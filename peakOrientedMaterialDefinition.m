...
function materialDefinition = peakOrientedMaterialDefinition(matTag, K0, as, My, Lambda, c, theta_p, theta_pc, Res, theta_u, D)
...
materialDefinition = sprintf('uniaxialMaterial ModIMKPeakOriented %i %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g',...
