...
function materialDefinition = peakOrientedMaterialDefinition(K0, as, My, Lambda, c, theta_p, theta_pc, Res, theta_u, D)
...
materialDefinition = sprintf('uniaxialMaterial ModIMKPeakOriented 1 %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g',...
